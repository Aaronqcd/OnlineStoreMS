...
public class CategoryField1Entity implements java.io.Serializable {
	@Autowired
	...
	/**商品分类编码*/
	@Excel(name="商品分类编码",width=15,dictTable ="category",dicCode ="categoryCode",dicText ="code")
	private String categoryCode;
	/**字段名*/
	@Excel(name="字段名",width=15)
	private String name;
	/**商品表字段*/
	@Excel(name="商品表字段",width=15)
